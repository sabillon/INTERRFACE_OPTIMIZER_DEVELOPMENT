...
class classoutput_F(DB.Model):
    ...
    Initial_Energy_schedule = DB.Column(DB.FLOAT)
    FK_NumberOfSet_output=DB.Column(DB.Integer,DB.ForeignKey('numberofst_output.id_NumberofSet_Output'))
...
class classoutput_accepted_F(DB.Model):
    ...
    Dispatch_Initial_Energy = DB.Column(DB.FLOAT)
    Dispatch_P = DB.Column(DB.FLOAT)
    Dispatch_Q = DB.Column(DB.FLOAT)
    Ofered_P_reserve_up=DB.Column(DB.FLOAT)
    Ofered_P_Power_accepted=DB.Column(DB.FLOAT)
    Ofered_Q_Power_accepted=DB.Column(DB.FLOAT)
    Ofered_P_reserve_down = DB.Column(DB.FLOAT)
    Ofered_Q_reserve_up = DB.Column(DB.FLOAT)
    Ofered_Q_reserve_down = DB.Column(DB.FLOAT)
    Ofered_Price_P_Reserve_up = DB.Column(DB.FLOAT)
    Ofered_Price_Q_Reserve_up = DB.Column(DB.FLOAT)
    Ofered_Price_P_Reserve_down = DB.Column(DB.FLOAT)
    Ofered_Price_Q_Reserve_down = DB.Column(DB.FLOAT)
    Dispatch_P_reserve_up = DB.Column(DB.FLOAT)
    Dispatch_P_reserve_down = DB.Column(DB.FLOAT)
    Dispatch_Q_reserve_up = DB.Column(DB.FLOAT)
    Dispatch_Q_reserve_down = DB.Column(DB.FLOAT)
    Final_Price_P_Reserve_up = DB.Column(DB.FLOAT)
    Final_Price_P_Reserve_down = DB.Column(DB.FLOAT)
    Final_Price_Q_Reserve_up = DB.Column(DB.FLOAT)
    Final_Price_Q_Reserve_down = DB.Column(DB.FLOAT)
